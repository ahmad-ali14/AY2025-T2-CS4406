...
`)+`
`+h);const y=T+p+o,S=T+h+a,N=vo(s,s.VERTEX_SHADER,y),A=vo(s,s.FRAGMENT_SHADER,S);s.attachShader(v,N),s.attachShader(v,A),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function w(R){if(i.debug.checkShaderErrors){const H=s.getProgramInfoLog(v).trim(),O=s.getShaderInfoLog(N).trim(),G=s.getShaderInfoLog(A).trim();let j=!0,W=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,N,A);else{const Q=Mo(s,N,"vertex"),V=Mo(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`;function Cp(i,t,e){let n=new _a;const s=new Et,r=new Et,o=new $t,a=new Tp({depthPacking:rc}),l=new Ap,c={},u=e.maxTextureSize,d={[En]:Ae,[Ae]:En,[nn]:nn},f=new yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Et},radius:{value:4}},vertexShader:wp,fragmentShader:Rp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const g=new ye;g.setAttribute("position",new ke(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new an(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vo;let h=this.type;this.render=function(A,w,L){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;const E=i.getRenderTarget(),M=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),H=i.state;H.setBlending(Mn),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const O=h!==en&&this.type===en,G=h===en&&this.type!==en;for(let j=0,W=A.length;j<W;j++){const Q=A[j],V=Q.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const nt=V.getFrameExtents();if(s.multiply(nt),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/nt.x),s.x=r.x*nt.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/nt.y),s.y=r.y*nt.y,V.mapSize.y=r.y)),V.map===null||O===!0||G===!0){const vt=this.type!==en?{minFilter:Ve,magFilter:Ve}:{};V.map!==null&&V.map.dispose(),V.map=new Bn(s.x,s.y,vt),V.map.texture.name=Q.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const ht=V.getViewportCount();for(let vt=0;vt<ht;vt++){const wt=V.getViewport(vt);o.set(r.x*wt.x,r.y*wt.y,r.x*wt.z,r.y*wt.w),H.viewport(o),V.updateMatrices(Q,vt),n=V.getFrustum(),S(w,L,V.camera,Q,this.type)}V.isPointLightShadow!==!0&&this.type===en&&T(V,L),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(E,M,R)};function T(A,w){const L=t.update(v);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Bn(s.x,s.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(w,null,L,f,v,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(w,null,L,m,v,null)}function y(A,w,L,E){let M=null;const R=L.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(R!==void 0)M=R;else if(M=L.isPointLight===!0?l:a,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const H=M.uuid,O=w.uuid;let G=c[H];G===void 0&&(G={},c[H]=G);let j=G[O];j===void 0&&(j=M.clone(),G[O]=j,w.addEventListener("dispose",N)),M=j}if(M.visible=w.visible,M.wireframe=w.wireframe,E===en?M.side=w.shadowSide!==null?w.shadowSide:w.side:M.side=w.shadowSide!==null?w.shadowSide:d[w.side],M.alphaMap=w.alphaMap,M.alphaTest=w.alphaTest,M.map=w.map,M.clipShadows=w.clipShadows,M.clippingPlanes=w.clippingPlanes,M.clipIntersection=w.clipIntersection,M.displacementMap=w.displacementMap,M.displacementScale=w.displacementScale,M.displacementBias=w.displacementBias,M.wireframeLinewidth=w.wireframeLinewidth,M.linewidth=w.linewidth,L.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const H=i.properties.get(M);H.light=L}return M}function S(A,w,L,E,M){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&M===en)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld);const O=t.update(A),G=A.material;if(Array.isArray(G)){const j=O.groups;for(let W=0,Q=j.length;W<Q;W++){const V=j[W],nt=G[V.materialIndex];if(nt&&nt.visible){const ht=y(A,nt,E,M);A.onBeforeShadow(i,A,w,L,O,ht,V),i.renderBufferDirect(L,null,O,ht,A,V),A.onAfterShadow(i,A,w,L,O,ht,V)}}}else if(G.visible){const j=y(A,G,E,M);A.onBeforeShadow(i,A,w,L,O,j,null),i.renderBufferDirect(L,null,O,j,A,null),A.onAfterShadow(i,A,w,L,O,j,null)}}const H=A.children;for(let O=0,G=H.length;O<G;O++)S(H[O],w,L,E,M)}function N(A){A.target.removeEventListener("dispose",N);for(const L in c){const E=c[L],M=A.target.uuid;M in E&&(E[M].dispose(),delete E[M])}}}const Pp={[xr]:Mr,[Sr]:br,[Er]:Tr,[di]:yr,[Mr]:xr,[br]:Sr,[Tr]:Er,[yr]:di};function Lp(i,t){function e(){let P=!1;const at=new $t;let k=null;const Z=new $t(0,0,0,0);return{setMask:function(ct){k!==ct&&!P&&(i.colorMask(ct,ct,ct,ct),k=ct)},setLocked:function(ct){P=ct},setClear:function(ct,ot,Pt,ae,_e){_e===!0&&(ct*=ae,ot*=ae,Pt*=ae),at.set(ct,ot,Pt,ae),Z.equals(at)===!1&&(i.clearColor(ct,ot,Pt,ae),Z.copy(at))},reset:function(){P=!1,k=null,Z.set(-1,0,0,0)}}}function n(){let P=!1,at=!1,k=null,Z=null,ct=null;return{setReversed:function(ot){if(at!==ot){const Pt=t.get("EXT_clip_control");at?Pt.clipControlEXT(Pt.LOWER_LEFT_EXT,Pt.ZERO_TO_ONE_EXT):Pt.clipControlEXT(Pt.LOWER_LEFT_EXT,Pt.NEGATIVE_ONE_TO_ONE_EXT);const ae=ct;ct=null,this.setClear(ae)}at=ot},getReversed:function(){return at},setTest:function(ot){ot?it(i.DEPTH_TEST):yt(i.DEPTH_TEST)},setMask:function(ot){k!==ot&&!P&&(i.depthMask(ot),k=ot)},setFunc:function(ot){if(at&&(ot=Pp[ot]),Z!==ot){switch(ot){case xr:i.depthFunc(i.NEVER);break;case Mr:i.depthFunc(i.ALWAYS);break;case Sr:i.depthFunc(i.LESS);break;case di:i.depthFunc(i.LEQUAL);break;case Er:i.depthFunc(i.EQUAL);break;case yr:i.depthFunc(i.GEQUAL);break;case br:i.depthFunc(i.GREATER);break;case Tr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Z=ot}},setLocked:function(ot){P=ot},setClear:function(ot){ct!==ot&&(at&&(ot=1-ot),i.clearDepth(ot),ct=ot)},reset:function(){P=!1,k=null,Z=null,ct=null,at=!1}}}function s(){let P=!1,at=null,k=null,Z=null,ct=null,ot=null,Pt=null,ae=null,_e=null;return{setTest:function(Yt){P||(Yt?it(i.STENCIL_TEST):yt(i.STENCIL_TEST))},setMask:function(Yt){at!==Yt&&!P&&(i.stencilMask(Yt),at=Yt)},setFunc:function(Yt,Ne,Ze){(k!==Yt||Z!==Ne||ct!==Ze)&&(i.stencilFunc(Yt,Ne,Ze),k=Yt,Z=Ne,ct=Ze)},setOp:function(Yt,Ne,Ze){(ot!==Yt||Pt!==Ne||ae!==Ze)&&(i.stencilOp(Yt,Ne,Ze),ot=Yt,Pt=Ne,ae=Ze)},setLocked:function(Yt){P=Yt},setClear:function(Yt){_e!==Yt&&(i.clearStencil(Yt),_e=Yt)},reset:function(){P=!1,at=null,k=null,Z=null,ct=null,ot=null,Pt=null,ae=null,_e=null}}}const r=new e,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let u={},d={},f=new WeakMap,m=[],g=null,v=!1,p=null,h=null,T=null,y=null,S=null,N=null,A=null,w=new Tt(0,0,0),L=0,E=!1,M=null,R=null,H=null,O=null,G=null;const j=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,Q=0;const V=i.getParameter(i.VERSION);V.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(V)[1]),W=Q>=1):V.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),W=Q>=2);let nt=null,ht={};const vt=i.getParameter(i.SCISSOR_BOX),wt=i.getParameter(i.VIEWPORT),Gt=new $t().fromArray(vt),X=new $t().fromArray(wt);function tt(P,at,k,Z){const ct=new Uint8Array(4),ot=i.createTexture();i.bindTexture(P,ot),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Pt=0;Pt<k;Pt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(at,0,i.RGBA,1,1,Z,0,i.RGBA,i.UNSIGNED_BYTE,ct):i.texImage2D(at+Pt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ct);return ot}const pt={};pt[i.TEXTURE_2D]=tt(i.TEXTURE_2D,i.TEXTURE_2D,1),pt[i.TEXTURE_CUBE_MAP]=tt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),pt[i.TEXTURE_2D_ARRAY]=tt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),pt[i.TEXTURE_3D]=tt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),it(i.DEPTH_TEST),o.setFunc(di),Ft(!1),Ot(Pa),it(i.CULL_FACE),D(Mn);function it(P){u[P]!==!0&&(i.enable(P),u[P]=!0)}function yt(P){u[P]!==!1&&(i.disable(P),u[P]=!1)}function Rt(P,at){return d[P]!==at?(i.bindFramebuffer(P,at),d[P]=at,P===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=at),P===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=at),!0):!1}function Nt(P,at){let k=m,Z=!1;if(P){k=f.get(at),k===void 0&&(k=[],f.set(at,k));const ct=P.textures;if(k.length!==ct.length||k[0]!==i.COLOR_ATTACHMENT0){for(let ot=0,Pt=ct.length;ot<Pt;ot++)k[ot]=i.COLOR_ATTACHMENT0+ot;k.length=ct.length,Z=!0}}else k[0]!==i.BACK&&(k[0]=i.BACK,Z=!0);Z&&i.drawBuffers(k)}function te(P){return g!==P?(i.useProgram(P),g=P,!0):!1}const Bt={[In]:i.FUNC_ADD,[Ll]:i.FUNC_SUBTRACT,[Dl]:i.FUNC_REVERSE_SUBTRACT};Bt[Il]=i.MIN,Bt[Ul]=i.MAX;const re={[Nl]:i.ZERO,[Fl]:i.ONE,[Ol]:i.SRC_COLOR,[gr]:i.SRC_ALPHA,[kl]:i.SRC_ALPHA_SATURATE,[Gl]:i.DST_COLOR,[zl]:i.DST_ALPHA,[Bl]:i.ONE_MINUS_SRC_COLOR,[vr]:i.ONE_MINUS_SRC_ALPHA,[Vl]:i.ONE_MINUS_DST_COLOR,[Hl]:i.ONE_MINUS_DST_ALPHA,[Wl]:i.CONSTANT_COLOR,[Xl]:i.ONE_MINUS_CONSTANT_COLOR,[Yl]:i.CONSTANT_ALPHA,[ql]:i.ONE_MINUS_CONSTANT_ALPHA};function D(P,at,k,Z,ct,ot,Pt,ae,_e,Yt){if(P===Mn){v===!0&&(yt(i.BLEND),v=!1);return}if(v===!1&&(it(i.BLEND),v=!0),P!==Pl){if(P!==p||Yt!==E){if((h!==In||S!==In)&&(i.blendEquation(i.FUNC_ADD),h=In,S=In),Yt)switch(P){case ci:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case La:i.blendFunc(i.ONE,i.ONE);break;case Da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ia:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case ci:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case La:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ia:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}T=null,y=null,N=null,A=null,w.set(0,0,0),L=0,p=P,E=Yt}return}ct=ct||at,ot=ot||k,Pt=Pt||Z,(at!==h||ct!==S)&&(i.blendEquationSeparate(Bt[at],Bt[ct]),h=at,S=ct),(k!==T||Z!==y||ot!==N||Pt!==A)&&(i.blendFuncSeparate(re[k],re[Z],re[ot],re[Pt]),T=k,y=Z,N=ot,A=Pt),(ae.equals(w)===!1||_e!==L)&&(i.blendColor(ae.r,ae.g,ae.b,_e),w.copy(ae),L=_e),p=P,E=!1}function me(P,at){P.side===nn?yt(i.CULL_FACE):it(i.CULL_FACE);let k=P.side===Ae;at&&(k=!k),Ft(k),P.blending===ci&&P.transparent===!1?D(Mn):D(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),o.setFunc(P.depthFunc),o.setTest(P.depthTest),o.setMask(P.depthWrite),r.setMask(P.colorWrite);const Z=P.stencilWrite;a.setTest(Z),Z&&(a.setMask(P.stencilWriteMask),a.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),a.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Zt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?it(i.SAMPLE_ALPHA_TO_COVERAGE):yt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ft(P){M!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),M=P)}function Ot(P){P!==wl?(it(i.CULL_FACE),P!==R&&(P===Pa?i.cullFace(i.BACK):P===Rl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):yt(i.CULL_FACE),R=P}function St(P){P!==H&&(W&&i.lineWidth(P),H=P)}function Zt(P,at,k){P?(it(i.POLYGON_OFFSET_FILL),(O!==at||G!==k)&&(i.polygonOffset(at,k),O=at,G=k)):yt(i.POLYGON_OFFSET_FILL)}function Mt(P){P?it(i.SCISSOR_TEST):yt(i.SCISSOR_TEST)}function b(P){P===void 0&&(P=i.TEXTURE0+j-1),nt!==P&&(i.activeTexture(P),nt=P)}function _(P,at,k){k===void 0&&(nt===null?k=i.TEXTURE0+j-1:k=nt);let Z=ht[k];Z===void 0&&(Z={type:void 0,texture:void 0},ht[k]=Z),(Z.type!==P||Z.texture!==at)&&(nt!==k&&(i.activeTexture(k),nt=k),i.bindTexture(P,at||pt[P]),Z.type=P,Z.texture=at)}function F(){const P=ht[nt];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Y(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function rt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ut(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function zt(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function dt(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function bt(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function At(P){Gt.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Gt.copy(P))}function ft(P){X.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),X.copy(P))}function Ht(P,at){let k=c.get(at);k===void 0&&(k=new WeakMap,c.set(at,k));let Z=k.get(P);Z===void 0&&(Z=i.getUniformBlockIndex(at,P.name),k.set(P,Z))}function It(P,at){const Z=c.get(at).get(P);l.get(at)!==Z&&(i.uniformBlockBinding(at,Z,P.__bindingPointIndex),l.set(at,Z))}function Jt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},nt=null,ht={},d={},f=new WeakMap,m=[],g=null,v=!1,p=null,h=null,T=null,y=null,S=null,N=null,A=null,w=new Tt(0,0,0),L=0,E=!1,M=null,R=null,H=null,O=null,G=null,Gt.set(0,0,i.canvas.width,i.canvas.height),X.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:it,disable:yt,bindFramebuffer:Rt,drawBuffers:Nt,useProgram:te,setBlending:D,setMaterial:me,setFlipSided:Ft,setCullFace:Ot,setLineWidth:St,setPolygonOffset:Zt,setScissorTest:Mt,activeTexture:b,bindTexture:_,unbindTexture:F,compressedTexImage2D:q,compressedTexImage3D:K,texImage2D:dt,texImage3D:bt,updateUBOMapping:Ht,uniformBlockBinding:It,texStorage2D:zt,texStorage3D:$,texSubImage2D:Y,texSubImage3D:J,compressedTexSubImage2D:rt,compressedTexSubImage3D:ut,scissor:At,viewport:ft,reset:Jt}}function Ro(i,t,e,n){const s=Dp(n);switch(e){case qo:return i*t;case jo:return i*t;case Ko:return i*t*2;case $o:return i*t/s.components*s.byteLength;case ca:return i*t/s.components*s.byteLength;case Jo:return i*t*2/s.components*s.byteLength;case ha:return i*t*2/s.components*s.byteLength;case Zo:return i*t*3/s.components*s.byteLength;case Ge:return i*t*4/s.components*s.byteLength;case ua:return i*t*4/s.components*s.byteLength;case Ss:case Es:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case ys:case bs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Lr:case Ir:return Math.max(i,16)*Math.max(t,8)/4;case Pr:case Dr:return Math.max(i,8)*Math.max(t,8)/2;case Ur:case Nr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Fr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Or:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Br:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case zr:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Hr:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Gr:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case Vr:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case kr:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case Wr:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Xr:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Yr:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case qr:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case Zr:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case jr:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case Kr:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case Ts:case $r:case Jr:return Math.ceil(i/4)*Math.ceil(t/4)*16;case Qo:case Qr:return Math.ceil(i/4)*Math.ceil(t/4)*8;case ta:case ea:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Dp(i){switch(i){case cn:case Wo:return{byteLength:1,components:1};case Ni:case Xo:case Bi:return{byteLength:2,components:1};case oa:case la:return{byteLength:2,components:4};case On:case aa:case sn:return{byteLength:4,components:1};case Yo:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Ip(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Et,u=new WeakMap;let d;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,_){return m?new OffscreenCanvas(b,_):Oi("canvas")}function v(b,_,F){let q=1;const K=Mt(b);if((K.width>F||K.height>F)&&(q=F/Math.max(K.width,K.height)),q<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const Y=Math.floor(q*K.width),J=Math.floor(q*K.height);d===void 0&&(d=g(Y,J));const rt=_?g(Y,J):d;return rt.width=Y,rt.height=J,rt.getContext("2d").drawImage(b,0,0,Y,J),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+Y+"x"+J+")."),rt}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),b;return b}function p(b){return b.generateMipmaps}function h(b){i.generateMipmap(b)}function T(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(b,_,F,q,K=!1){if(b!==null){if(i[b]!==void 0)return i[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let Y=_;if(_===i.RED&&(F===i.FLOAT&&(Y=i.R32F),F===i.HALF_FLOAT&&(Y=i.R16F),F===i.UNSIGNED_BYTE&&(Y=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.R8UI),F===i.UNSIGNED_SHORT&&(Y=i.R16UI),F===i.UNSIGNED_INT&&(Y=i.R32UI),F===i.BYTE&&(Y=i.R8I),F===i.SHORT&&(Y=i.R16I),F===i.INT&&(Y=i.R32I)),_===i.RG&&(F===i.FLOAT&&(Y=i.RG32F),F===i.HALF_FLOAT&&(Y=i.RG16F),F===i.UNSIGNED_BYTE&&(Y=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RG8UI),F===i.UNSIGNED_SHORT&&(Y=i.RG16UI),F===i.UNSIGNED_INT&&(Y=i.RG32UI),F===i.BYTE&&(Y=i.RG8I),F===i.SHORT&&(Y=i.RG16I),F===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),F===i.UNSIGNED_INT&&(Y=i.RGB32UI),F===i.BYTE&&(Y=i.RGB8I),F===i.SHORT&&(Y=i.RGB16I),F===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),F===i.UNSIGNED_INT&&(Y=i.RGBA32UI),F===i.BYTE&&(Y=i.RGBA8I),F===i.SHORT&&(Y=i.RGBA16I),F===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),_===i.RGBA){const J=K?Ds:Vt.getTransfer(q);F===i.FLOAT&&(Y=i.RGBA32F),F===i.HALF_FLOAT&&(Y=i.RGBA16F),F===i.UNSIGNED_BYTE&&(Y=J===jt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function S(b,_){let F;return b?_===null||_===On||_===mi?F=i.DEPTH24_STENCIL8:_===sn?F=i.DEPTH32F_STENCIL8:_===Ni&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===On||_===mi?F=i.DEPTH_COMPONENT24:_===sn?F=i.DEPTH_COMPONENT32F:_===Ni&&(F=i.DEPTH_COMPONENT16),F}function N(b,_){return p(b)===!0||b.isFramebufferTexture&&b.minFilter!==Ve&&b.minFilter!==qe?Math.log2(Math.max(_.width,_.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?_.mipmaps.length:1}function A(b){const _=b.target;_.removeEventListener("dispose",A),L(_),_.isVideoTexture&&u.delete(_)}function w(b){const _=b.target;_.removeEventListener("dispose",w),M(_)}function L(b){const _=n.get(b);if(_.__webglInit===void 0)return;const F=b.source,q=f.get(F);if(q){const K=q[_.__cacheKey];K.usedTimes--,K.usedTimes===0&&E(b),Object.keys(q).length===0&&f.delete(F)}n.remove(b)}function E(b){const _=n.get(b);i.deleteTexture(_.__webglTexture);const F=b.source,q=f.get(F);delete q[_.__cacheKey],o.memory.textures--}function M(b){const _=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(_.__webglFramebuffer[q]))for(let K=0;K<_.__webglFramebuffer[q].length;K++)i.deleteFramebuffer(_.__webglFramebuffer[q][K]);else i.deleteFramebuffer(_.__webglFramebuffer[q]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[q])}else{if(Array.isArray(_.__webglFramebuffer))for(let q=0;q<_.__webglFramebuffer.length;q++)i.deleteFramebuffer(_.__webglFramebuffer[q]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let q=0;q<_.__webglColorRenderbuffer.length;q++)_.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[q]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=b.textures;for(let q=0,K=F.length;q<K;q++){const Y=n.get(F[q]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),o.memory.textures--),n.remove(F[q])}n.remove(b)}let R=0;function H(){R=0}function O(){const b=R;return b>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+s.maxTextures),R+=1,b}function G(b){const _=[];return _.push(b.wrapS),_.push(b.wrapT),_.push(b.wrapR||0),_.push(b.magFilter),_.push(b.minFilter),_.push(b.anisotropy),_.push(b.internalFormat),_.push(b.format),_.push(b.type),_.push(b.generateMipmaps),_.push(b.premultiplyAlpha),_.push(b.flipY),_.push(b.unpackAlignment),_.push(b.colorSpace),_.join()}function j(b,_){const F=n.get(b);if(b.isVideoTexture&&St(b),b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){const q=b.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(F,b,_);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function W(b,_){const F=n.get(b);if(b.version>0&&F.__version!==b.version){X(F,b,_);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function Q(b,_){const F=n.get(b);if(b.version>0&&F.__version!==b.version){X(F,b,_);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function V(b,_){const F=n.get(b);if(b.version>0&&F.__version!==b.version){tt(F,b,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const nt={[Rr]:i.REPEAT,[Nn]:i.CLAMP_TO_EDGE,[Cr]:i.MIRRORED_REPEAT},ht={[Ve]:i.NEAREST,[ic]:i.NEAREST_MIPMAP_NEAREST,[ki]:i.NEAREST_MIPMAP_LINEAR,[qe]:i.LINEAR,[Bs]:i.LINEAR_MIPMAP_NEAREST,[Fn]:i.LINEAR_MIPMAP_LINEAR},vt={[oc]:i.NEVER,[fc]:i.ALWAYS,[lc]:i.LESS,[tl]:i.LEQUAL,[cc]:i.EQUAL,[dc]:i.GEQUAL,[hc]:i.GREATER,[uc]:i.NOTEQUAL};function wt(b,_){if(_.type===sn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===qe||_.magFilter===Bs||_.magFilter===ki||_.magFilter===Fn||_.minFilter===qe||_.minFilter===Bs||_.minFilter===ki||_.minFilter===Fn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,nt[_.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,nt[_.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,nt[_.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,ht[_.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,ht[_.minFilter]),_.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,vt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ve||_.minFilter!==ki&&_.minFilter!==Fn||_.type===sn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(b,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Gt(b,_){let F=!1;b.__webglInit===void 0&&(b.__webglInit=!0,_.addEventListener("dispose",A));const q=_.source;let K=f.get(q);K===void 0&&(K={},f.set(q,K));const Y=G(_);if(Y!==b.__cacheKey){K[Y]===void 0&&(K[Y]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),K[Y].usedTimes++;const J=K[b.__cacheKey];J!==void 0&&(K[b.__cacheKey].usedTimes--,J.usedTimes===0&&E(_)),b.__cacheKey=Y,b.__webglTexture=K[Y].texture}return F}function X(b,_,F){let q=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(q=i.TEXTURE_3D);const K=Gt(b,_),Y=_.source;e.bindTexture(q,b.__webglTexture,i.TEXTURE0+F);const J=n.get(Y);if(Y.version!==J.__version||K===!0){e.activeTexture(i.TEXTURE0+F);const rt=Vt.getPrimaries(Vt.workingColorSpace),ut=_.colorSpace===xn?null:Vt.getPrimaries(_.colorSpace),zt=_.colorSpace===xn||rt===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);let $=v(_.image,!1,s.maxTextureSize);$=Zt(_,$);const dt=r.convert(_.format,_.colorSpace),bt=r.convert(_.type);let At=y(_.internalFormat,dt,bt,_.colorSpace,_.isVideoTexture);wt(q,_);let ft;const Ht=_.mipmaps,It=_.isVideoTexture!==!0,Jt=J.__version===void 0||K===!0,P=Y.dataReady,at=N(_,$);if(_.isDepthTexture)At=S(_.format===_i,_.type),Jt&&(It?e.texStorage2D(i.TEXTURE_2D,1,At,$.width,$.height):e.texImage2D(i.TEXTURE_2D,0,At,$.width,$.height,0,dt,bt,null));else if(_.isDataTexture)if(Ht.length>0){It&&Jt&&e.texStorage2D(i.TEXTURE_2D,at,At,Ht[0].width,Ht[0].height);for(let k=0,Z=Ht.length;k<Z;k++)ft=Ht[k],It?P&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,ft.width,ft.height,dt,bt,ft.data):e.texImage2D(i.TEXTURE_2D,k,At,ft.width,ft.height,0,dt,bt,ft.data);_.generateMipmaps=!1}else It?(Jt&&e.texStorage2D(i.TEXTURE_2D,at,At,$.width,$.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,$.width,$.height,dt,bt,$.data)):e.texImage2D(i.TEXTURE_2D,0,At,$.width,$.height,0,dt,bt,$.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){It&&Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,at,At,Ht[0].width,Ht[0].height,$.depth);for(let k=0,Z=Ht.length;k<Z;k++)if(ft=Ht[k],_.format!==Ge)if(dt!==null)if(It){if(P)if(_.layerUpdates.size>0){const ct=Ro(ft.width,ft.height,_.format,_.type);for(const ot of _.layerUpdates){const Pt=ft.data.subarray(ot*ct/ft.data.BYTES_PER_ELEMENT,(ot+1)*ct/ft.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,ot,ft.width,ft.height,1,dt,Pt)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,ft.width,ft.height,$.depth,dt,ft.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,k,At,ft.width,ft.height,$.depth,0,ft.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,ft.width,ft.height,$.depth,dt,bt,ft.data):e.texImage3D(i.TEXTURE_2D_ARRAY,k,At,ft.width,ft.height,$.depth,0,dt,bt,ft.data)}else{It&&Jt&&e.texStorage2D(i.TEXTURE_2D,at,At,Ht[0].width,Ht[0].height);for(let k=0,Z=Ht.length;k<Z;k++)ft=Ht[k],_.format!==Ge?dt!==null?It?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,k,0,0,ft.width,ft.height,dt,ft.data):e.compressedTexImage2D(i.TEXTURE_2D,k,At,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?P&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,ft.width,ft.height,dt,bt,ft.data):e.texImage2D(i.TEXTURE_2D,k,At,ft.width,ft.height,0,dt,bt,ft.data)}else if(_.isDataArrayTexture)if(It){if(Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,at,At,$.width,$.height,$.depth),P)if(_.layerUpdates.size>0){const k=Ro($.width,$.height,_.format,_.type);for(const Z of _.layerUpdates){const ct=$.data.subarray(Z*k/$.data.BYTES_PER_ELEMENT,(Z+1)*k/$.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,$.width,$.height,1,dt,bt,ct)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,dt,bt,$.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,$.width,$.height,$.depth,0,dt,bt,$.data);else if(_.isData3DTexture)It?(Jt&&e.texStorage3D(i.TEXTURE_3D,at,At,$.width,$.height,$.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,dt,bt,$.data)):e.texImage3D(i.TEXTURE_3D,0,At,$.width,$.height,$.depth,0,dt,bt,$.data);else if(_.isFramebufferTexture){if(Jt)if(It)e.texStorage2D(i.TEXTURE_2D,at,At,$.width,$.height);else{let k=$.width,Z=$.height;for(let ct=0;ct<at;ct++)e.texImage2D(i.TEXTURE_2D,ct,At,k,Z,0,dt,bt,null),k>>=1,Z>>=1}}else if(Ht.length>0){if(It&&Jt){const k=Mt(Ht[0]);e.texStorage2D(i.TEXTURE_2D,at,At,k.width,k.height)}for(let k=0,Z=Ht.length;k<Z;k++)ft=Ht[k],It?P&&e.texSubImage2D(i.TEXTURE_2D,k,0,0,dt,bt,ft):e.texImage2D(i.TEXTURE_2D,k,At,dt,bt,ft);_.generateMipmaps=!1}else if(It){if(Jt){const k=Mt($);e.texStorage2D(i.TEXTURE_2D,at,At,k.width,k.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,dt,bt,$)}else e.texImage2D(i.TEXTURE_2D,0,At,dt,bt,$);p(_)&&h(q),J.__version=Y.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function tt(b,_,F){if(_.image.length!==6)return;const q=Gt(b,_),K=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+F);const Y=n.get(K);if(K.version!==Y.__version||q===!0){e.activeTexture(i.TEXTURE0+F);const J=Vt.getPrimaries(Vt.workingColorSpace),rt=_.colorSpace===xn?null:Vt.getPrimaries(_.colorSpace),ut=_.colorSpace===xn||J===rt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);const zt=_.isCompressedTexture||_.image[0].isCompressedTexture,$=_.image[0]&&_.image[0].isDataTexture,dt=[];for(let Z=0;Z<6;Z++)!zt&&!$?dt[Z]=v(_.image[Z],!0,s.maxCubemapSize):dt[Z]=$?_.image[Z].image:_.image[Z],dt[Z]=Zt(_,dt[Z]);const bt=dt[0],At=r.convert(_.format,_.colorSpace),ft=r.convert(_.type),Ht=y(_.internalFormat,At,ft,_.colorSpace),It=_.isVideoTexture!==!0,Jt=Y.__version===void 0||q===!0,P=K.dataReady;let at=N(_,bt);wt(i.TEXTURE_CUBE_MAP,_);let k;if(zt){It&&Jt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,at,Ht,bt.width,bt.height);for(let Z=0;Z<6;Z++){k=dt[Z].mipmaps;for(let ct=0;ct<k.length;ct++){const ot=k[ct];_.format!==Ge?At!==null?It?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,0,0,ot.width,ot.height,At,ot.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,Ht,ot.width,ot.height,0,ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,0,0,ot.width,ot.height,At,ft,ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct,Ht,ot.width,ot.height,0,At,ft,ot.data)}}}else{if(k=_.mipmaps,It&&Jt){k.length>0&&at++;const Z=Mt(dt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,at,Ht,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if($){It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,dt[Z].width,dt[Z].height,At,ft,dt[Z].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ht,dt[Z].width,dt[Z].height,0,At,ft,dt[Z].data);for(let ct=0;ct<k.length;ct++){const Pt=k[ct].image[Z].image;It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,0,0,Pt.width,Pt.height,At,ft,Pt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,Ht,Pt.width,Pt.height,0,At,ft,Pt.data)}}else{It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,At,ft,dt[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ht,At,ft,dt[Z]);for(let ct=0;ct<k.length;ct++){const ot=k[ct];It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,0,0,At,ft,ot.image[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ct+1,Ht,At,ft,ot.image[Z])}}}p(_)&&h(i.TEXTURE_CUBE_MAP),Y.__version=K.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function pt(b,_,F,q,K,Y){const J=r.convert(F.format,F.colorSpace),rt=r.convert(F.type),ut=y(F.internalFormat,J,rt,F.colorSpace),zt=n.get(_),$=n.get(F);if($.__renderTarget=_,!zt.__hasExternalTextures){const dt=Math.max(1,_.width>>Y),bt=Math.max(1,_.height>>Y);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?e.texImage3D(K,Y,ut,dt,bt,_.depth,0,J,rt,null):e.texImage2D(K,Y,ut,dt,bt,0,J,rt,null)}e.bindFramebuffer(i.FRAMEBUFFER,b),Ot(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,K,$.__webglTexture,0,Ft(_)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,K,$.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function it(b,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,b),_.depthBuffer){const q=_.depthTexture,K=q&&q.isDepthTexture?q.type:null,Y=S(_.stencilBuffer,K),J=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,rt=Ft(_);Ot(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt,Y,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt,Y,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Y,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,b)}else{const q=_.textures;for(let K=0;K<q.length;K++){const Y=q[K],J=r.convert(Y.format,Y.colorSpace),rt=r.convert(Y.type),ut=y(Y.internalFormat,J,rt,Y.colorSpace),zt=Ft(_);F&&Ot(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,zt,ut,_.width,_.height):Ot(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,zt,ut,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ut,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function yt(b,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,b),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=n.get(_.depthTexture);q.__renderTarget=_,(!q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),j(_.depthTexture,0);const K=q.__webglTexture,Y=Ft(_);if(_.depthTexture.format===hi)Ot(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0);else if(_.depthTexture.format===_i)Ot(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function Rt(b){const _=n.get(b),F=b.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==b.depthTexture){const q=b.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),q){const K=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,q.removeEventListener("dispose",K)};q.addEventListener("dispose",K),_.__depthDisposeCallback=K}_.__boundDepthTexture=q}if(b.depthTexture&&!_.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");yt(_.__webglFramebuffer,b)}else if(F){_.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[q]),_.__webglDepthbuffer[q]===void 0)_.__webglDepthbuffer[q]=i.createRenderbuffer(),it(_.__webglDepthbuffer[q],b,!1);else{const K=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=_.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,Y)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),it(_.__webglDepthbuffer,b,!1);else{const q=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,K=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,K),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,K)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Nt(b,_,F){const q=n.get(b);_!==void 0&&pt(q.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Rt(b)}function te(b){const _=b.texture,F=n.get(b),q=n.get(_);b.addEventListener("dispose",w);const K=b.textures,Y=b.isWebGLCubeRenderTarget===!0,J=K.length>1;if(J||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=_.version,o.memory.textures++),Y){F.__webglFramebuffer=[];for(let rt=0;rt<6;rt++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[rt]=[];for(let ut=0;ut<_.mipmaps.length;ut++)F.__webglFramebuffer[rt][ut]=i.createFramebuffer()}else F.__webglFramebuffer[rt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let rt=0;rt<_.mipmaps.length;rt++)F.__webglFramebuffer[rt]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(J)for(let rt=0,ut=K.length;rt<ut;rt++){const zt=n.get(K[rt]);zt.__webglTexture===void 0&&(zt.__webglTexture=i.createTexture(),o.memory.textures++)}if(b.samples>0&&Ot(b)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let rt=0;rt<K.length;rt++){const ut=K[rt];F.__webglColorRenderbuffer[rt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[rt]);const zt=r.convert(ut.format,ut.colorSpace),$=r.convert(ut.type),dt=y(ut.internalFormat,zt,$,ut.colorSpace,b.isXRRenderTarget===!0),bt=Ft(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,bt,dt,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.RENDERBUFFER,F.__webglColorRenderbuffer[rt])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),it(F.__webglDepthRenderbuffer,b,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),wt(i.TEXTURE_CUBE_MAP,_);for(let rt=0;rt<6;rt++)if(_.mipmaps&&_.mipmaps.length>0)for(let ut=0;ut<_.mipmaps.length;ut++)pt(F.__webglFramebuffer[rt][ut],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,ut);else pt(F.__webglFramebuffer[rt],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0);p(_)&&h(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(J){for(let rt=0,ut=K.length;rt<ut;rt++){const zt=K[rt],$=n.get(zt);e.bindTexture(i.TEXTURE_2D,$.__webglTexture),wt(i.TEXTURE_2D,zt),pt(F.__webglFramebuffer,b,zt,i.COLOR_ATTACHMENT0+rt,i.TEXTURE_2D,0),p(zt)&&h(i.TEXTURE_2D)}e.unbindTexture()}else{let rt=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(rt=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(rt,q.__webglTexture),wt(rt,_),_.mipmaps&&_.mipmaps.length>0)for(let ut=0;ut<_.mipmaps.length;ut++)pt(F.__webglFramebuffer[ut],b,_,i.COLOR_ATTACHMENT0,rt,ut);else pt(F.__webglFramebuffer,b,_,i.COLOR_ATTACHMENT0,rt,0);p(_)&&h(rt),e.unbindTexture()}b.depthBuffer&&Rt(b)}function Bt(b){const _=b.textures;for(let F=0,q=_.length;F<q;F++){const K=_[F];if(p(K)){const Y=T(b),J=n.get(K).__webglTexture;e.bindTexture(Y,J),h(Y),e.unbindTexture()}}}const re=[],D=[];function me(b){if(b.samples>0){if(Ot(b)===!1){const _=b.textures,F=b.width,q=b.height;let K=i.COLOR_BUFFER_BIT;const Y=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=n.get(b),rt=_.length>1;if(rt)for(let ut=0;ut<_.length;ut++)e.bindFramebuffer(i.FRAMEBUFFER,J.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,J.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,J.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,J.__webglFramebuffer);for(let ut=0;ut<_.length;ut++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),rt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,J.__webglColorRenderbuffer[ut]);const zt=n.get(_[ut]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,zt,0)}i.blitFramebuffer(0,0,F,q,0,0,F,q,K,i.NEAREST),l===!0&&(re.length=0,D.length=0,re.push(i.COLOR_ATTACHMENT0+ut),b.depthBuffer&&b.resolveDepthBuffer===!1&&(re.push(Y),D.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,D)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,re))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),rt)for(let ut=0;ut<_.length;ut++){e.bindFramebuffer(i.FRAMEBUFFER,J.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,J.__webglColorRenderbuffer[ut]);const zt=n.get(_[ut]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,J.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,zt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,J.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const _=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Ft(b){return Math.min(s.maxSamples,b.samples)}function Ot(b){const _=n.get(b);return b.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function St(b){const _=o.render.frame;u.get(b)!==_&&(u.set(b,_),b.update())}function Zt(b,_){const F=b.colorSpace,q=b.format,K=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||F!==vi&&F!==xn&&(Vt.getTransfer(F)===jt?(q!==Ge||K!==cn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),_}function Mt(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=H,this.setTexture2D=j,this.setTexture2DArray=W,this.setTexture3D=Q,this.setTextureCube=V,this.rebindTextures=Nt,this.setupRenderTarget=te,this.updateRenderTargetMipmap=Bt,this.updateMultisampleRenderTarget=me,this.setupDepthRenderbuffer=Rt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=Ot}function Up(i,t){function e(n,s=xn){let r;const o=Vt.getTransfer(s);if(n===cn)return i.UNSIGNED_BYTE;if(n===oa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===la)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Yo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Wo)return i.BYTE;if(n===Xo)return i.SHORT;if(n===Ni)return i.UNSIGNED_SHORT;if(n===aa)return i.INT;if(n===On)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===Bi)return i.HALF_FLOAT;if(n===qo)return i.ALPHA;if(n===Zo)return i.RGB;if(n===Ge)return i.RGBA;if(n===jo)return i.LUMINANCE;if(n===Ko)return i.LUMINANCE_ALPHA;if(n===hi)return i.DEPTH_COMPONENT;if(n===_i)return i.DEPTH_STENCIL;if(n===$o)return i.RED;if(n===ca)return i.RED_INTEGER;if(n===Jo)return i.RG;if(n===ha)return i.RG_INTEGER;if(n===ua)return i.RGBA_INTEGER;if(n===Ss||n===Es||n===ys||n===bs)if(o===jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ss)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Es)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===bs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ss)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Es)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ys)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===bs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Pr||n===Lr||n===Dr||n===Ir)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Pr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Lr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Dr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ir)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ur||n===Nr||n===Fr)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ur||n===Nr)return o===jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Fr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Or||n===Br||n===zr||n===Hr||n===Gr||n===Vr||n===kr||n===Wr||n===Xr||n===Yr||n===qr||n===Zr||n===jr||n===Kr)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Or)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Br)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===zr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Hr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Gr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Vr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===kr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Wr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Xr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Yr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===qr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Zr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===jr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Kr)return o===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ts||n===$r||n===Jr)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Ts)return o===jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===$r)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Jr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Qo||n===Qr||n===ta||n===ea)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ts)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Qr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ta)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ea)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===mi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class Np extends Pe{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class hs extends pe{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Fp={type:"move"};class ur{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new hs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new hs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new C,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new C),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new hs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new C,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new C),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const v of t.hand.values()){const p=e.getJointPose(v,n),h=this._getHandJoint(c,v);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const u=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=u.position.distanceTo(d.position),m=.02,g=.005;c.inputState.pinching&&f>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Fp)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new hs;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Op=`
void main() {
...
void main() {
    ...
    `,N.appendChild(j);const W=document.getElementById("showGrid"),Q=document.getElementById("showAxes"),V=document.getElementById("useOrbitControls"),nt=document.getElementById("showWireframe"),ht=document.getElementById("showLabels");W.checked=L,Q.checked=w,V.checked=E,nt.checked=M,ht.checked=R,W.addEventListener("change",()=>{H.visible=W.checked}),Q.addEventListener("change",()=>{O.visible=Q.checked}),V.addEventListener("change",()=>{G.enabled=V.checked}),nt.addEventListener("change",()=>{M=nt.checked}),ht.addEventListener("change",()=>{R=ht.checked});const vt=[vm,xm],wt=document.createElement("div");wt.id="helpModal",wt.classList.add("fixed","top-0","left-0","w-full","h-full","bg-black","bg-opacity-50","flex","items-center","justify-center","hidden");const Gt=document.createElement("div");Gt.classList.add("bg-white","p-6","rounded-lg","shadow-lg","text-center","max-w-5xl","w-full"),Gt.innerHTML=`
    ...
    `,wt.appendChild(Gt),document.body.appendChild(wt);const X=Gt.querySelector("#closeHelp");X==null||X.addEventListener("click",()=>{wt.classList.add("hidden")});const tt=document.createElement("div");tt.innerHTML=`<div class="flex fixed bottom-1 w-full max-w-[18%]">
    <button class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded w-full">
       ? Help
    </button>
    </div>`,N.appendChild(tt),tt.addEventListener("click",()=>{const J=Gt.querySelector("#helpModalContent");if(!J)throw new Error("Modal content not found");J.innerHTML=vt.map(rt=>{const{title:ut,points:zt,description:$}=rt;return`
                <div class="mb-5">
                    <h2 class="text-2xl font-bold mb-4 border-b pb-1">${ut}</h2>
                    ${$?`<p class="mb-2 text-left">${$}</p>`:""}
                    <ul class="text-left mb-4 list-disc pl-6">
                    ${zt.map(dt=>`<li>${dt}</li>`).join("")}
                    </ul>
                </div>
            `}).join(" "),wt.classList.remove("hidden")});const pt=J=>{vt.push(J)},it=document.createElement("div");it.classList.add("mb-4");const yt=-c.width,Rt=c.height,Nt=c.width,te=-c.height,Bt=-e,re=e;it.innerHTML=`
    <hr class="border border-b-[#000] mb-2" />
    ...
    <div class="flex flex-col space-y-2 text-lg">
      ...
      <div>
        ...
        <div class="flex items-center space-x-2">
            ...
            <input type="range" id="directionalLightPosX" min="${yt}" max="${Nt}" step="0.1" value="1.0">
        </div>
        <div class="flex items-center space-x-2">
            <span class="font-bold">Y:</span>
            <input type="range" id="directionalLightPosY" min="${te}" max="${Rt}" step="0.1" value="1.0">
        </div>
        <div class="flex items-center space-x-2">
            <span class="font-bold">Z:</span>
            <input type="range" id="directionalLightPosZ" min="${Bt}" max="${re}" step="0.1" value="1.0">
        </div>
        </div>
      <div class="border-b"></div>
      <div>
    ...
    `,N.appendChild(it);const D=document.getElementById("useAmbientLight"),me=document.getElementById("useDirectionalLight"),Ft=document.getElementById("usePointLight"),Ot=document.getElementById("ambientLightColor"),St=document.getElementById("directionalLightColor"),Zt=document.getElementById("ambientLightIntensity"),Mt=document.getElementById("directionalLightIntensity"),b=document.getElementById("pointLightColor"),_=document.getElementById("pointLightIntensity"),F=document.getElementById("directionalLightPosX"),q=document.getElementById("directionalLightPosY"),K=document.getElementById("directionalLightPosZ");D.checked=i.useAmbientLight??!0,me.checked=i.useDirectionalLight??!0,Ft.checked=i.usePointLight??!0,D.value=s,me.value=s,Ft.value=s,F.value=y.position.x.toString(),q.value=y.position.y.toString(),K.value=y.position.z.toString(),F.addEventListener("input",()=>{y.position.x=parseFloat(F.value)}),q.addEventListener("input",()=>{y.position.y=parseFloat(q.value)}),K.addEventListener("input",()=>{y.position.z=parseFloat(K.value)}),Zt.addEventListener("input",()=>{v.traverse(J=>{J instanceof vs&&(J.intensity=parseFloat(Zt.value))})}),D.addEventListener("change",()=>{v.traverse(J=>{J instanceof vs&&(J.visible=D.checked)})}),me.addEventListener("change",()=>{v.traverse(J=>{J instanceof gs&&(J.visible=me.checked)})}),Ot.addEventListener("input",()=>{v.traverse(J=>{J instanceof vs&&(J.color=new Tt(Ot.value))})}),St.addEventListener("input",()=>{v.traverse(J=>{J instanceof gs&&(J.color=new Tt(St.value))})}),Mt.addEventListener("input",()=>{v.traverse(J=>{J instanceof gs&&(J.intensity=parseFloat(Mt.value))})}),Ft.addEventListener("change",()=>{v.traverse(J=>{J instanceof _s&&(J.visible=Ft.checked)})}),b.addEventListener("input",()=>{v.traverse(J=>{J instanceof _s&&(J.color=new Tt(b.value))})}),_.addEventListener("input",()=>{v.traverse(J=>{J instanceof _s&&(J.intensity=parseFloat(_.value))})});const Y=new em(p);return v.add(Y),Y.visible=!1,window.addEventListener("resize",()=>{S.setSize(window.innerWidth,window.innerHeight),p.aspect=window.innerWidth/window.innerHeight,p.updateProjectionMatrix()}),{canvas:c,scene:v,camera:p,renderer:S,render:()=>{S.render(v,p)},addHelpNote:pt,shouldShowWireframe:()=>M,shouldShowLabels:()=>R,sidebar:N,ambientLight:h,viewpointLight:T,directionalLight:y}};export{ye as B,Tt as C,nn as D,se as F,hs as G,an as M,Mn as N,Cl as P,Ml as S,Sl as T,C as V,ke as a,bm as b,Am as c,Pc as d,al as e,Us as f,ym as g,Hi as h,Tm as i,xl as j,Em as k,qp as l,Sm as m};
//# sourceMappingURL=createBaseScene-BkKOSq5h.js.map
